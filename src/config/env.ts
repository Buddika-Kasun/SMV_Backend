...
export const config = {
  ...
  databaseUrl:
    ...
    'postgresql://postgres:postgres@localhost:5432/smv_holdings',
  jwt: {
  ...
  sms: {
    ...
    senderId: process.env.TEXT_LK_SENDER_ID ?? 'SMVHoldings',
    url: process.env.TEXT_LK_URL ?? 'https://api.textlk.com/sms/send',
  },
