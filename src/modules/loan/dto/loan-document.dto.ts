...
export class PresignDocumentDto {
  @ApiProperty({
    description: 'Original file name of the document (used to build the storage key).',
...
export class AttachDocumentDto {
  ...
  @ApiProperty({ description: 'Display file name stored with the document record.', example: 'national-id-front.jpg' })
  @IsString()
  @IsNotEmpty()
  fileName!: string;
}